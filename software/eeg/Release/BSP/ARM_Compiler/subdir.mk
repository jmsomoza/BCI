...
BSP/ARM_Compiler/armv7a_tthelp.o: ../BSP/ARM_Compiler/armv7a_tthelp.s
	...
	armasm -g --md --depend_format=unix_escaped --depend="BSP/ARM_Compiler/armv7a_tthelp.d" -o "$@" "$<"
...
BSP/ARM_Compiler/bsp_cache.o: ../BSP/ARM_Compiler/bsp_cache.s
	@echo 'Building file: $<'
	@echo 'Invoking: ARM Assembler 5'
	armasm -g --md --depend_format=unix_escaped --depend="BSP/ARM_Compiler/bsp_cache.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
...
BSP/ARM_Compiler/startup.o: ../BSP/ARM_Compiler/startup.s
	@echo 'Building file: $<'
	@echo 'Invoking: ARM Assembler 5'
	armasm -g --md --depend_format=unix_escaped --depend="BSP/ARM_Compiler/startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
